...
import { Shield, Lock, Cookie, FileText, Smile, RefreshCw } from "lucide-react";
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          >
            ...
            <div className="text-center mb-16">
              <div
                className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-greekblue to-greekteal rounded-full mb-6"
                aria-hidden="true"
              >
                  ...
                  <Card className="card-professional hover-lift">
                    <CardContent className="p-8">
                      <div className="flex items-start gap-4">
                        <div
                          className="w-12 h-12 bg-gradient-to-r from-greekblue to-greekteal rounded-lg flex items-center justify-center"
                          aria-hidden="true"
                        >
              ...
              <Card className="card-professional">
                <CardContent className="p-8">
                  <h3 className="text-xl font-semibold mb-4 flex items-center gap-2">
                    <Cookie className="w-5 h-5 text-greekteal" /> Cookies and
                    Tracking
                  </h3>
