...
const HeroSection = () => {
  ...
  const stats = [
    ...
    { icon: Code, value: "8+", label: "Projects Completed" },
  ...
  const devs = [
    {
      ...
      image: dev1,
      socials: [
        { icon: "ri-github-fill", link: "https://github.com/KimonasXXX482" },
        { icon: "ri-facebook-fill", link: "https://www.facebook.com/profile.php?id=61557650911975&sk=about" },
        { icon: "ri-instagram-fill", link: "https://www.instagram.com/eydokim0s_07/" }
      ]
    },
    {
      ...
      image: dev2,
      socials: [
        { icon: "ri-github-fill", link: "https://github.com/Tasos007" },
        { icon: "ri-facebook-fill", link: "https://www.facebook.com/mpiztast/" },
        { icon: "ri-instagram-fill", link: "https://www.instagram.com/tasosmpakasetas/" },
      ]
    }
  ];
                    ...
                    <div className="flex justify-center gap-4 pt-3">
                      {dev.socials.map((social, index) => (
                        <a
                          ...
                          aria-label={social.icon.replace('ri-', '').replace('-fill', '').replace('-', ' ').replace(/\b\w/g, l => l.toUpperCase())}
                          title={social.icon.replace('ri-', '').replace('-fill', '').replace('-', ' ').replace(/\b\w/g, l => l.toUpperCase())}
                        >
